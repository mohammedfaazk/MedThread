...
var _edge_runtime_cookies = __webpack_require__(7925);
...
var modern_browserslist_target = __webpack_require__(8174);
...
var async_local_storage = __webpack_require__(4744);
...
function ensureTestApisIntercepted() {
    if (!testApisIntercepted) {
        ...
        if (process.env.NEXT_PRIVATE_TEST_PROXY === "true") {
            const { interceptTestApis, wrapRequestHandler } = __webpack_require__(8600);
            interceptTestApis();
...
async function middleware(req) {
    ...
    // Authentication is handled by the API with JWT tokens
    // Frontend will check auth state using the auth store
    return res;
}
...
const _context = __webpack_require__(5545);
const reader = {
    url (req) {
        return req.url;
    },
...
const _context = __webpack_require__(5545);
const _fetch = __webpack_require__(4802);
...
/******/ var __webpack_exports__ = (__webpack_exec__(1167));
