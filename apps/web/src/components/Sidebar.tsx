        ...
        <div className="sticky top-[68px] p-4">
          ...
          <div className="bg-white/40 backdrop-blur-xl rounded-2xl border border-white/20 mb-4 shadow-lg">
            <div className="px-4 py-3 border-b border-neutral-400/20 flex items-center justify-between">
              <h3 className="text-xs font-bold text-gray-500 uppercase">Communities</h3>
              <Link
                ...
                communities.map((community) => (
                  <Link
                    ...
                    className={`w-full text-left px-4 py-2 text-sm hover:bg-gray-50 flex items-center justify-between transition-all ${
                      pathname === `/m/${community.name}` ? 'bg-blue-500/10 text-blue-600 font-semibold' : 'text-gray-600'
                    }`}
                  >
          ...
          <div className="bg-white/40 backdrop-blur-xl rounded-2xl border border-white/20 mb-4 shadow-lg">
            ...
            <Link
              href="/saved"
              className={`w-full flex items-center gap-3 px-4 py-2.5 text-sm hover:bg-gray-50 transition-all ${pathname === '/saved' ? 'bg-blue-500/10 text-blue-600 font-semibold' : 'text-gray-600'}`}
            >
            ...
            <Link
              href="/hidden"
              className={`w-full flex items-center gap-3 px-4 py-2.5 text-sm hover:bg-gray-50 transition-all ${pathname === '/hidden' ? 'bg-blue-500/10 text-blue-600 font-semibold' : 'text-gray-600'}`}
            >
              <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <Link
              href="/history"
              className={`w-full flex items-center gap-3 px-4 py-2.5 text-sm hover:bg-gray-50 transition-all ${pathname === '/history' ? 'bg-blue-500/10 text-blue-600 font-semibold' : 'text-gray-600'}`}
            >
              <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <Link
              href="/leaderboard"
              className={`w-full flex items-center gap-3 px-4 py-2.5 text-sm hover:bg-gray-50 transition-all ${pathname === '/leaderboard' ? 'bg-blue-500/10 text-blue-600 font-semibold' : 'text-gray-600'}`}
            >
              <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <Link
              href="/shop"
              className={`w-full flex items-center gap-3 px-4 py-2.5 text-sm hover:bg-gray-50 transition-all ${pathname === '/shop' ? 'bg-blue-500/10 text-blue-600 font-semibold' : 'text-gray-600'}`}
            >
