      ...
      <div className="max-w-[1400px] mx-auto px-6 h-12 flex items-center gap-4">
        ...
        <div className="flex items-center gap-2">
          ...
          <div className="relative">
            ...
            {showNotifications && (
              <div className="absolute right-0 top-12 w-80 bg-white border border-gray-300 rounded shadow-lg">
                ...
                <div className="max-h-96 overflow-y-auto">
                  ...
                  <div className="p-4 hover:bg-gray-50 cursor-pointer border-b border-gray-100">
                    <p className="text-sm">Your post received 10 upvotes</p>
          ...
          <div className="relative">
            ...
            {showUserMenu && (
              <div className="absolute right-0 top-12 w-56 bg-white border border-gray-300 rounded shadow-lg">
                <Link href="/profile" className="block px-4 py-3 hover:bg-gray-50 border-b border-gray-100">
                ...
                <Link href="/history" className="block px-4 py-2 hover:bg-gray-50 text-sm">
                  History
                </Link>
          ...
          <Link
            href="/login"
            className="px-4 py-1.5 bg-[#FF4500] text-white rounded-full text-sm font-semibold hover:bg-[#ff5722]"
          >
            Log In
          </Link>
        </div>
