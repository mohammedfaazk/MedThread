      ...
      <div className="max-w-[1400px] mx-auto px-6 flex items-center gap-4">
        ...
        <div ref={searchRef} className="flex-1 max-w-[500px] relative">
          ...
          {(showRecentSearches || showAutocompleteSuggestions) && (
            <div className="absolute top-full left-0 right-0 mt-2 bg-white/95 backdrop-blur-xl border border-white/20 rounded-2xl shadow-2xl overflow-hidden max-h-96 overflow-y-auto z-50">
              {/* Recent Searches */}
              {showRecentSearches && (
                <div>
        ...
        <div className="flex items-center gap-3">
          {user ? (
            <>
              {/* Notifications - Curved Container */}
              <NotificationBell />
