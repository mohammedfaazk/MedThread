  ...
  return (
    <div
      ...
      className={`p-4 rounded-xl border transition-all cursor-pointer hover:shadow-md ${
        isSelected
          ? 'bg-blue-50/80 border-blue-500 ring-1 ring-blue-500 shadow-md backdrop-blur-sm'
          : 'bg-white/60 border-white/20 hover:bg-white/80 backdrop-blur-sm'
      }`}
    >
      ...
      <div className="flex items-start gap-1.5 text-gray-600 text-sm mb-4">
