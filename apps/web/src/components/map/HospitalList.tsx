  ...
  if (loading) {
    return (
      <div className="p-4 space-y-4">
        {[1, 2, 3].map(i => (
          <div key={i} className="animate-pulse bg-white/60 backdrop-blur-sm p-4 rounded-xl border border-white/20 h-32">
    ...
    return (
      <div className="p-8 text-center text-gray-600">
        <div className="bg-white/60 backdrop-blur-sm rounded-xl border border-white/20 p-6">
          ...
          <p className="text-sm text-gray-500 mt-1">Try adjusting your location or search radius</p>
        </div>
      </div>
    );
  }
