        ...
        <CardHeader>
          <div className="flex items-center justify-between">
            <div>
              ...
              <CardDescription>
                Highest performing doctors based on patient feedback
              </CardDescription>
            </div>
            <select
              value={sortBy}
        ...
        <CardContent>
          <div className="space-y-4">
            {leaderboard.map((doctor, index) => (
              <div key={doctor.doctorId} className="flex items-center gap-4 p-4 bg-gray-50 rounded-lg hover:bg-gray-100 transition">
