    ...
    <div className="min-h-screen">
      ...
      <div className="max-w-4xl mx-auto px-6 py-12">
        <div className="bg-white/80 backdrop-blur-md rounded-2xl border border-white/20 p-8 shadow-soft">
          <h1 className="text-4xl font-bold mb-6 text-charcoal">Terms of Service</h1>
          <p className="text-sm text-gray-600 mb-8">Last updated: January 2024</p>
          
          <div className="prose max-w-none space-y-6">
            <section>
              <h2 className="text-2xl font-bold mb-3 text-charcoal">1. Acceptance of Terms</h2>
            ...
            <section>
              <h2 className="text-2xl font-bold mb-3 text-charcoal">2. Medical Disclaimer</h2>
              <p className="text-gray-700">
            ...
            <section>
              <h2 className="text-2xl font-bold mb-3 text-charcoal">3. User Conduct</h2>
              <p className="text-gray-700">
            ...
            <section>
              <h2 className="text-2xl font-bold mb-3 text-charcoal">4. Privacy</h2>
              <p className="text-gray-700">
