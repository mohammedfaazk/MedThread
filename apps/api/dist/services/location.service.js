...
class LocationService {
     ...
     */
    calculateDistanceFormatted(lat1, lon1, lat2, lon2) {
     ...
     */
    batchCalculateDistances(origin, destinations) {
        return destinations.map(dest => ({
            id: dest.id,
            distance: this.calculateDistanceFormatted(origin.latitude, origin.longitude, dest.latitude, dest.longitude)
        }));
    }
}
