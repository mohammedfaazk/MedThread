...
class AdminService {
    ...
    async getPlatformStats() {
        const [totalUsers, totalPosts, totalComments, totalCommunities, activeUsers24h, newUsersToday, totalDoctors, verifiedDoctors, pendingVerifications,] = await Promise.all([
            ...
            database_1.prisma.post.count({ where: { isPrivate: false } }), // Exclude private posts from public stats
            database_1.prisma.comment.count({ where: { isPrivateReply: false } }), // Exclude private replies from public stats
