...
class PreferencesService {
    ...
    async getPreferences(userId) {
        try {
            let preferences = await database_1.prisma.notificationPreferences.findUnique({
                where: { userId },
            });
            if (!preferences) {
    ...
    async updatePreferences(userId, updates) {
        try {
            ...
            const preferences = await database_1.prisma.notificationPreferences.update({
                where: { userId },
                data: {
    ...
    async createDefaultPreferences(userId) {
        try {
            ...
            const preferences = await database_1.prisma.notificationPreferences.create({
                data: {
                    userId,
