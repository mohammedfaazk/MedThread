...
async function testParseMentions() {
    ...
    const mentions1 = post_service_1.postService.parseMentions('Hello @user1 and @user2!');
    ...
    const mentions3 = post_service_1.postService.parseMentions('@user1 @user1 @user1');
    ...
    const mentions4 = comment_service_1.commentService.parseMentions('No mentions here');
    ...
    const mentions5 = post_service_1.postService.parseMentions('@start middle @end');
    ...
    const mentions6 = comment_service_1.commentService.parseMentions('Hey @user_123 and @test456');
    ...
    const mentions7 = post_service_1.postService.parseMentions('@UserName @ALLCAPS @lowercase');
