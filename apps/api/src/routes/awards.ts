 ...
 */
router.post('/give', authenticate, requireVerifiedDoctor, asyncHandler(async (req, res) => {
 ...
 */
router.get('/user/:userId/given', asyncHandler(async (req, res) => {
 ...
 */
router.get('/user/:userId/received', asyncHandler(async (req, res) => {
 ...
 */
router.get('/coins/me', authenticate, asyncHandler(async (req, res) => {
 ...
 */
router.post('/coins/add', authenticate, asyncHandler(async (req, res) => {
 ...
 */
router.get('/stats/platform', asyncHandler(async (req, res) => {
