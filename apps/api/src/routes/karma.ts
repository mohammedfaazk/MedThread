 ...
 */
router.post('/update/:userId', authenticate, asyncHandler(async (req, res) => {
 ...
 */
router.get('/leaderboard/doctors', asyncHandler(async (req, res) => {
  const limit = Math.min(parseInt(req.query.limit as string) || 50, 100);
  const offset = parseInt(req.query.offset as string) || 0;
 ...
 */
router.get('/leaderboard/specialty/:specialty', asyncHandler(async (req, res) => {
 ...
 */
router.get('/rank/me', authenticate, asyncHandler(async (req, res) => {
