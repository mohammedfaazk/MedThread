...
export class BlockService {
   ...
   */
  async getBlockedUsers(userId: string, cursor?: string, limit: number = 20) {
   ...
   */
  private async deactivateConversations(userId1: string, userId2: string) {
    try {
   ...
   */
  private async cancelAppointmentsBetweenUsers(userId1: string, userId2: string) {
    try {
